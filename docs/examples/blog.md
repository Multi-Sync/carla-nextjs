...
>
> **Carla**: _Calls POST /api/posts/search with query="Next.js"_
>
...
>
> **Carla**: _Calls GET /api/authors with name filter_
>
...
export async function GET(request: Request) {
  ...
  if (!postSlug) {
    return Response.json({ error: 'Post slug required' }, { status: 400 });
  }
...
> **User**: "Yes please"
>
> **Carla**: _Opens post_ "Here's the article! It's a 15-minute read. Let me know if you have questions while reading. By the way, Sarah has also written a follow-up on 'Custom Hooks for Beginners' if you want to continue learning after this one!"
...
>
> **Carla**: _Initiates subscription_
>
> "Great choice! What's your email?"
>
> **User**: "john@example.com"
>
> **Carla**: _Completes subscription_
>
